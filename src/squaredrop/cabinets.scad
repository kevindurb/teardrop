...
module rounded_cutout(width, height, radius = inches(1), thickness = inches(1.25)) {
...
module interior_cabinets_face() {
  difference() {
    ...
    color_wood()
      rounded_cutout(third_cabinet_width - inches(4), interior_cabinets_height - inches(3));
    ...
    color_wood()
      rounded_cutout(third_cabinet_width - inches(4), inches(4));

    // middle top cutout
    translate([third_cabinet_width + inches(2), inches(-10.75), inches(9.25)])
    color_wood()
      rounded_cutout(third_cabinet_width - inches(4), inches(12.25));
  }
}
